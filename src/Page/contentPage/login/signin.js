  ...
  return (
    ...
    <table>
        ...
        <tr>
            ...
            <td><input name='id' /><span id='idDetail'>(영문소문자/숫자,4~16자)</span> <button>아이디 중복 확인</button></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input name='passwodConfirm' type='password'/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input name='addr1' placeholder='우편번호' /></td>
        </tr>
        <tr>
            <td className='col1'></td>
            <td><input name='addr2' placeholder='기본주소'/></td>
        </tr>
        <tr>
            <td className='col1'></td>
            <td><input name='addr3' placeholder='상세주소' /></td>
        </tr>
        <tr>
