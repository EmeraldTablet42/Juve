...
const Join = () => {
  ...
  useEffect(() => {
    ...
    setIsAllValidate((prev) => ({ ...prev, terms: isChecked }));
  }, [requireInfoAgreed, personalInfoAgreed, getDbList]);
      ...
      <table id="basicInfo" className="joinTbl" onKeyDown={handleKeyEvent}>
        <tr>
          ...
          <td>
            ...
            <span
              className={`verifyMsg ${
                isAllValidate.id ? "verifyMsg_valid" : ""
              }`}
            >
              {verifyIdMsg}
            </span>
        ...
        <tr>
          ...
          <td>
            ...
            <span
              className={`verifyMsg ${
                isAllValidate.password ? "verifyMsg_valid" : ""
              }`}
            >
              {" "}
              {verifyPwMsg}
