...
SELECT JPR_productcode FROM JUVE_PRODUCT_RECOMMENDATION jpr WHERE  jpr_age BETWEEN 10 AND 19 ;
...
UPDATE JUVE_ORDER SET JO_ORDERSTATUS = 2 WHERE JO_ID = 'test';
...
DROP TABLE JUVE_MEMBER_FAVORITE;

CREATE SEQUENCE JUVE_MEMBER_FAVORITE_SEQ;

DELETE FROM JUVE_MEMBER_FAVORITE;

SELECT * FROM JUVE_MEMBER_FAVORITE;

INSERT INTO JUVE_MEMBER_FAVORITE values(
1,'test','SAL-001'
);
INSERT INTO JUVE_MEMBER_FAVORITE values(
2,'test','SAL-002'
